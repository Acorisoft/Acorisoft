...
namespace Acorisoft.Extensions.Platforms.Windows.Controls
{
    public class EmptyStateView: ContentControl
    {
        ...
        public static readonly DependencyProperty HasContentStateProperty = DependencyProperty.Register("HasContentState",
            typeof(bool), typeof(EmptyStateView), new PropertyMetadata(Xaml.Box(false), OnHasContentStateChanged));

        public static readonly DependencyProperty IsEmptyStateProperty = DependencyProperty.Register("IsEmptyState",
            typeof(bool), typeof(EmptyStateView), new PropertyMetadata(Xaml.Box(false), OnIsEmptyStateChanged));
        ...
        public bool HasContentState
        {
            ...
            set => SetValue(HasContentStateProperty, Xaml.Box(value));
        }
        public bool IsEmptyState
        {
            get => (bool) GetValue(IsEmptyStateProperty);
            set => SetValue(IsEmptyStateProperty, Xaml.Box(value));
        }
