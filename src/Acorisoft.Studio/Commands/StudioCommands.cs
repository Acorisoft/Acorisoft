...
namespace Acorisoft.Studio.Commands
{
    public static class StudioCommands
    {
        ...
        public static RoutedCommand GotoFunction { get; } = new RoutedUICommand("GotoFunction", "GotoFunction", typeof(StudioCommands));
        ...
        public static RoutedCommand NewInspirationFromClipboard { get; } = new RoutedUICommand("NewInspirationFromClipboard", "NewInspirationFromClipboard", typeof(StudioCommands));
        #endregion
